  ...
  const steps = [
    {
      ...
      desc: "Chaque nappe, circuit et contrôleur tactile est branché sur nos bancs de test dédiés pour mesurer la stabilité des tensions et éviter les faux contacts."
    },
    {
      icon: <Cpu size={28} className="text-brand-primary" />,
      title: "Vérification des Dalles",
      desc: "Les écrans subissent des mires de couleurs rigoureuses pour valider la colorimétrie, l'homogénéité du rétroéclairage et la réactivité du capacitif 100% sans pixel mort."
    },
    {
      icon: <Award size={28} className="text-brand-primary" />,
      title: "Service Pack Original",
      desc: "Nous privilégions les approvisionnements directs auprès des centres de distribution officiels pour vous garantir des pièces d'origine constructeur d'une fiabilité absolue."
    }
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 space-y-16">
        ...
        <section className="text-center max-w-3xl mx-auto space-y-6">
          <motion.div
            ...
            className="space-y-2"
          >
            <span className="text-xs font-black uppercase tracking-widest text-brand-primary">Qui sommes-nous</span>
        ...
        <section className="bg-brand-card rounded-[32px] border border-gray-200 p-8 md:p-12 grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <div className="space-y-6">
            <div className="space-y-1">
              <span className="text-xs font-black uppercase tracking-widest text-brand-primary">Diagnostic & Fiabilité</span>
              <h2 className="text-2xl md:text-3xl font-black text-slate-800 uppercase">LE COMPORTEMENT DU VRAI MATÉRIEL</h2>
            </div>
            ...
            <ul className="space-y-3.5 text-xs font-bold text-slate-700">
              <li className="flex items-center space-x-2.5">
                ...
                <span>Garantie à vie sur les écrans (défaut tactile et afficheur)</span>
              </li>
              <li className="flex items-center space-x-2.5">
                <CheckCircle size={15} className="text-brand-primary" />
                <span>Protection thermique certifiée sur les batteries Li-ion</span>
              </li>
              <li className="flex items-center space-x-2.5">
                <CheckCircle size={15} className="text-brand-primary" />
                <span>Support direct technicien et grilles de tarifs B2B flexibles</span>
              </li>
            </ul>
          </div>
        ...
        <section className="text-center max-w-2xl mx-auto py-8">
          <div className="p-4 bg-gray-50/50 border border-gray-200 rounded-[20px] flex items-center space-x-4 text-left">
            ...
            <div>
              <h4 className="text-xs font-black text-slate-800 uppercase tracking-wider">Un Partenariat de Confiance</h4>
